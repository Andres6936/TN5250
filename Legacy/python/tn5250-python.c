...
Tn5250_DisplayType;
staticforward PyTypeObject
Tn5250_DisplayBufferType;
staticforward PyTypeObject
Tn5250_FieldType;
staticforward PyTypeObject
Tn5250_PrintSessionType;
staticforward PyTypeObject
Tn5250_RecordType;
				...
				PyObject* value;
{
	...
	if (!strcmp(name, "attribute"))
		return tn5250_Field_setattr_helper(&self->field->attribute, sizeof(self->field->attribute),
				value);
	if (!strcmp(name, "start_row"))
		return tn5250_Field_setattr_helper(&self->field->start_row, sizeof(self->field->start_row),
				value);
	if (!strcmp(name, "start_col"))
		return tn5250_Field_setattr_helper(&self->field->start_col, sizeof(self->field->start_col),
				value);
	if (!strcmp(name, "length"))
		return tn5250_Field_setattr_helper(&self->field->length, sizeof(self->field->length),
				value);
	if (!strcmp(name, "display_width"))
